...
public class KafkaConsumer {
	...
	@KafkaListener(topics = "my-topic-2", groupId = "my-new-group")
	...
	public void listenRiderLocation(RiderLocation location) {
		System.out.println("Received location: "+ location.getRiderId() + " latitude: "+ location.getLatitude() + " longitude: " + location.getLongitude());
	}
}
